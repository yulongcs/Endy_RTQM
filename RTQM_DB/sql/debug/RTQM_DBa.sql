/*
Deployment script for RTQM_DBa
*/
...
CREATE DATABASE [$(DatabaseName)]
    ON 
    PRIMARY(NAME = [RTQM_DBa], FILENAME = N'$(DefaultDataPath)RTQM_DBa.mdf')
    LOG ON (NAME = [RTQM_DBa_log], FILENAME = N'$(DefaultLogPath)RTQM_DBa_log.ldf') COLLATE SQL_Latin1_General_CP1_CI_AS
GO
