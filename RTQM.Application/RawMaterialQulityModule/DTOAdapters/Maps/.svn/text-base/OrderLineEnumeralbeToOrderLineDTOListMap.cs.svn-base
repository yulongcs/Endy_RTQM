...
{
    class OrderLineEnumeralbeToOrderLineDTOListMap : TypeMapConfigurationBase<IEnumerable<OrderLine>, List<OrderLineDTO>>
    {
        #region Overrides of TypeMapConfigurationBase<IEnumerable<OrderLine>,List<OrderLineDTO>>
